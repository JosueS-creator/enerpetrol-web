...
import { LayoutDashboard, MapPin, Users, Receipt, BarChart3, LogOut, Gift, MessageSquare, Building2, Wallet, Megaphone, Map } from 'lucide-react'
...
const NAV = [
  ...
  { to: '/admin/canjes', label: 'Canjes', icon: Wallet },
